...
public class MySQLOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query = "CREATE TABLE " + TABLE_NAME + "(_login TEXT PRIMARY KEY, " +
                COLUMN_PSW + " TEXT, " + COLUMN_NAME + " TEXT, " + COLUMN_SURNAME + " TEXT, " +
                COLUMN_DRIVER_LICENSE + " INTEGER, " + COLUMN_LICENSE +" INTEGER);";
